...
function copyFormData() {
    document.getElementById('facultyNameHidden').value = document.querySelector('input[placeholder="Enter full name"]').value;
    document.getElementById('emailHidden').value = document.querySelector('input[type="email"]').value;
    document.getElementById('billDateHidden').value = document.querySelector('input[type="date"]').value;
    document.getElementById('theoryTotalHidden').value = document.getElementById('theoryTotal').value;
    document.getElementById('practicalTotalHidden').value = document.getElementById('practicalTotal').value;
    // ... baaki fields bhi copy karo
}

// Submit button pe onclick add karo
document.querySelector('.add:last-child').onclick = function(e) {
    copyFormData();
};
